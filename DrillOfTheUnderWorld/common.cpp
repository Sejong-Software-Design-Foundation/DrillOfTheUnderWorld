...
void initialize() {
    ...
    removeCursor();
    srand((unsigned)time(NULL)); // ÔøΩﬂ∞ÔøΩÔøΩÔøΩ ÔøΩ◊∏ÔøΩ
}

// NPC ÔøΩÔøΩÔøΩÔøΩ ÔøΩÔøΩÔøΩÔøΩÔø?
...
void initStageImage() { // ÏµúÏ¥à ?§ÌÖå?¥Ï? Í¥Ä???¥Î?ÏßÄÎ•??ùÏÑ±
...
void initAreaUI() // ÏµúÏ¥à ?êÏñ¥Î¶¨Ïñ¥ UI Í¥Ä???¥Î?ÏßÄÎ•??ùÏÑ±
{
